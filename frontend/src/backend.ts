...
import type { MeetingPlatform as _MeetingPlatform, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdateMeetingLink(arg0: string, arg1: MeetingPlatform, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateMeetingLink(arg0, to_candid_MeetingPlatform_n8(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeMeetingLink(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeMeetingLink(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_MeetingPlatform_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MeetingPlatform): _MeetingPlatform {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MeetingPlatform): {
    zoom: null;
} | {
    googleMeet: null;
} | {
    ...
    return value == MeetingPlatform.zoom ? {
        zoom: null
    } : value == MeetingPlatform.googleMeet ? {
        googleMeet: null
    } : value == MeetingPlatform.zohoMeet ? {
        zohoMeet: null
    } : value;
}
